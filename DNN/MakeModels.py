...
def main():
    ...
    hyperParameters = OrderedDict([
        ...
        ('filterInputs',           ['VBF_jets','PF_VBF','PF_UE_charged','PF_UE_neutrals',
                                   ...
                                   ['VBF_jets','PF_VBF','PF_UE_charged','PF_UE_neutrals'],
                                   ['VBF_jets', 'non_VBF_jets'],
                                   ['eventCategory-3','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['eventCategory-2','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['eventCategory-1','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['eventCategory0','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['eventCategory1','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['eventCategory2','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['eventCategory','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['VBF_jets', 'non_VBF_jets', 'eventCategory-3','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['VBF_jets', 'non_VBF_jets', 'eventCategory-2','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['VBF_jets', 'non_VBF_jets', 'eventCategory-1','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['VBF_jets', 'non_VBF_jets', 'eventCategory0','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['VBF_jets', 'non_VBF_jets', 'eventCategory1','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['VBF_jets', 'non_VBF_jets', 'eventCategory2','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['VBF_jets', 'non_VBF_jets', 'eventCategory','Zeppenfeld','energy_density_ratio','nonVBF_jets'],
                                   ['all'],
                                   ]),
    ])
