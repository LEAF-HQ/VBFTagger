...
def Add_Signals_VBF(SampleContainer):
    SampleContainer.add_samples( {
        'VBF_HToZZTo4L_M125': Sample(
            ...
            tuplepaths=YearDependentContainer({'UL18': Storage_T2ULB('/store/user/anmalara/Tuples/VBF/VBF_HToZZTo4L_M125')}),
...
def Add_Signals_WH_HToZZTo4L(SampleContainer):
    SampleContainer.add_samples( {
        'WminusH_HToZZTo4L_M125': Sample(
            ...
            tuplepaths=YearDependentContainer({'UL18': Storage_T2ULB('/store/user/anmalara/Tuples/VBF/WminusH_HToZZTo4L_M125')}),
            xsecs=YearDependentContainer(),
        ...
        'WplusH_HToZZTo4L_M125': Sample(
            ...
            tuplepaths=YearDependentContainer({'UL18': Storage_T2ULB('/store/user/anmalara/Tuples/VBF/WplusH_HToZZTo4L_M125')}),
            xsecs=YearDependentContainer(),
...
def Add_Signals_GluGlu(SampleContainer):
    SampleContainer.add_samples( {
        'GluGluHToZZTo4L_M125': Sample(
            ...
            tuplepaths=YearDependentContainer({'UL18': Storage_T2ULB('/store/user/anmalara/Tuples/VBF/GluGluHToZZTo4L_M125')}),
            xsecs=YearDependentContainer(),
        ...
        'GluGluToZH_HToZZTo4L_M125': Sample(
            ...
            tuplepaths=YearDependentContainer({'UL18': Storage_T2ULB('/store/user/anmalara/Tuples/VBF/GluGluToZH_HToZZTo4L_M125')}),
            xsecs=YearDependentContainer(),
        ...
        'GluGluHToZZTo4Mu_M125': Sample(
            ...
            tuplepaths=YearDependentContainer({'UL18': Storage_T2ULB('/store/user/anmalara/Tuples/VBF/GluGluHToZZTo4Mu_M125')}),
            xsecs=YearDependentContainer(),
...
def Add_Signals_ZZTo4L(SampleContainer):
    SampleContainer.add_samples( {
        'ZZTo4L': Sample(
            ...
            tuplepaths=YearDependentContainer({'UL18': Storage_T2ULB('/store/user/anmalara/Tuples/VBF/ZZTo4L')}),
            xsecs=YearDependentContainer(),
